...
customerNames = ['Putin', 'Modi', 'Amit', 'Rahul', 'Sunny']
customerPins = ['0123', '0123', '0123', '0123', '0123']
customerBalances = [90000000, 2000000, 2000000, 4000000, 1000000]
deposition = 0
withdrawal = 0
balance = 0
counter_1 = 1
...
while True:
    ...
    if choiceNumber == "1":
        ...
        # The line below will take the no:of customers from the user.(Coding-Pranav Sharma)
        NOC = eval(input("Number of Customers : "))
 
        i = i + NOC
        # The if condition will restrict the number of new account to 5.(Coding-Pranav Sharma)
        if i > 5:
            print("\n")
            print("Customer registration exceed reached or Customer registration too low")
            i = i - NOC
        else:
            # The while loop will run according to the no:of customers.(Coding-Pranav Sharma)
            while counter_1 <= i:
                # These few lines will take information from customer and then append them to the list.(Coding-Pranav Sharma)
                ...
                # This statement below helps the user to go back to the start of the program (main menu).(Coding-Pranav Sharma)
        ...
        # This while loop will prevent the user using the account if the username or pin is wrong.(Coding-Pranav Sharma)
        while j < 1:
            k = -1
            ...
            # customerNames list.(Coding-Pranav Sharma)
